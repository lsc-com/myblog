            ...
            <div class="player">
                <div class="player__top">
                    ...
                    <div class="player-controls">
                        ...
                        <a @click="musicLists" class="player-controls__item">
                            <svg class="icon">
                                <use xlink:href="#icon-c-icon-yinleliebiao1x"></use>
                            </svg>
                        </a>
...
<!--                    <el-slider id="elProgress" v-model="barWidth" @input="changeProgress" :show-tooltip="false"></el-slider>-->
                </div>
                <div v-cloak></div>
            </div>
            <div :class="music_obj">
                <div class="music-lists-header">
                    播放列表(共10首)
                    <span @click="musicListsOut">
                        <i class="el-icon-close"></i>
                    </span>
                </div>
                <ul>
                    <li v-for="(lists,index) in tracks"
                        :key="lists.id"
                        @click="updateMusic(lists,index)"
                        :style="index === musicIndex ?musicActive:''">
                        <span>{{lists.artist}}</span>
                ...
                tracks: [
                    {
                        artist: "红旗颂",
                        name: "上海电影乐团",
                        cover: require('../../../public/music/imgs/hqs.jpg'),
                        source: require('../../../public/music/hqs.mp3'),
                        url: "#",
                        favorited: true
                    },
                    {
                        artist: "新春乐",
                        name: "吕思清",
                        cover: require('../../../public/music/imgs/lsq.jpg'),
                        source: require('../../../public/music/spring.mp3'),
                        url: "#",
                        favorited: false
                    },
                    {
                        artist: "盗墓笔记·十年人间",
                        name: "老乾妈",
                        cover: require('../../../public/music/imgs/daomu.jpg'),
                        source: require('../../../public/music/daomu.mp3'),
                        url: "#",
                        favorited: false
                    },
                    {
                        artist: "熬夜上瘾",
                        name: "刘艺心",
                        cover: require('../../../public/music/imgs/aysy.jpg'),
                        source: require('../../../public/music/aysy.mp3'),
                        url: "#",
                        favorited: false
                    },
                    {
                        artist: "加沃特舞曲",
                        name: "中国爱乐乐团",
                        cover: require('../../../public/music/imgs/jwt.jpg'),
                        source: require('../../../public/music/jwt.mp3'),
                        url: "#",
                        favorited: false
                    },
                    {
                        artist: "世间美好与你环环相扣",
                        name: "柏松",
                        cover: require('../../../public/music/imgs/sjmh.jpg'),
                        source: require('../../../public/music/sjmh.mp3'),
                        url: "#",
                        favorited: false
                    },
                    {
                        artist: "有点甜",
                        name: "汪苏泷",
                        cover: require('../../../public/music/imgs/sweet.jpg'),
                        source: require('../../../public/music/sweet.mp3'),
                        url: "#",
                        favorited: false
                    },
                    {
                        artist: "遇见",
                        name: "孙燕姿",
                        cover: require('../../../public/music/imgs/yj.jpg'),
                        source: require('../../../public/music/yj.mp3'),
                        url: "#",
                        favorited: false
                    },
                    {
                        artist: "同福客栈",
                        name: "武林外传",
                        cover: require('../../../public/music/imgs/tfkz.jpg'),
                        source: require('../../../public/music/tfkz.mp3'),
                        url: "#",
                        favorited: false
                    },
                    {
                        artist: "星球大战",
                        name: "中国爱乐乐团",
                        cover: require('../../../public/music/imgs/xqdz.jpg'),
                        source: require('../../../public/music/xqdz.mp3'),
                        url: "#",
                        favorited: false
                    }
        ...
        methods: {
            ...
            musicListsOut() {
                this.music_obj = {
                    init_music: false,
                    music_lists: false,
                    music_lists_out: true
                }
            },
            updateMusic(lists,index){
                this.musicIndex = index
                this.currentTrack = lists
            ...
            generateTime() {
                let width = (100 / this.audio.duration) * this.audio.currentTime; // 计算宽度百分比
                this.barWidth = width;
            ...
            // changeProgress() {
            //     this.audio.pause();
            //     // var elProgress = document.getElementsByClassName("el-slider__button-wrapper");
            //     var elProgress = document.getElementsByClassName("el-slider__bar");
            //     this.isTimerPlaying = true;
            //     // let x =  elProgress[0].offsetLeft
            //     let x =  elProgress[0].offsetWidth
            ...
            resetPlayer() {
                ...
                for (var i = 0 ; i < this.tracks.length; i++){
                    if (this.currentTrack.source == this.tracks[i].source){
                        this.musicIndex = i
                    }
                }
                setTimeout(() => {
