<template>
    <div class="music">
        ...
        <div class="audioplayer" id="music-container">
            <div class="ap-status">
                <!-- 播放列表 -->
                <div :class="{'ap-playlist-hide': !listShow}" class="ap-playlist">
                    <!-- 列表头部 -->
                    <div class="ap-playlist-header">
                        ...
                        <div @click="handleList" class="ap-playlist-header-close">×</div>
                    </div>
                    <!-- 列表内容 -->
                    <div class="ap-playlist-body ps">
                        <ol>
                            ...
                            >
                                <div class="ap-playlist-line-name">{{li.name}}</div>
                ...
                <div class="ap-controller">
                    <div class="ap-controller-left">
                        <!-- 封面 -->
                        <div :style="{backgroundImage: 'url('+song.cover+')'}" class="ap-cover"></div>
                        <!-- 上一首 -->
                        <div @click="skipBack" class="ap-button ap-skipback-button">
                        ...
                        <!-- 播放与暂停 -->
                        <div @click="play" class="ap-button ap-play-button">
                            <svg
                                    v-if="!playing"
                                    version="1.1"
                                    viewBox="0 0 32 32"
                            ...
                            <svg v-else version="1.1" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
                                <path
                        ...
                        <!-- 下一首 -->
                        <div @click="skipForward" class="ap-button ap-skipforward-button">
                            <svg version="1.1" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
                                <path
                        ...
                        <div class="ap-progress-line">
                            <div class="ap-play-track" ref="track">
                                ...
                                <div class="ap-play-bar-wrap">
                                    <!-- 缓存进度 -->
                                    <div :style="{transform: 'scaleX('+bufferedScaleX+')'}" class="ap-buffer-bar"></div>
                                    <!-- 当前进度 -->
                                    <div
                    ...
                    <div class="ap-controller-right">
                        ...
                        <!-- 播放模式 -->
                        <div @click="chosePlayType" class="ap-button ap-order-button">
                            <!-- 列表循环 -->
                            <svg
                                    v-if="playType == 1"
                                    version="1.1"
                        ...
                        <!-- 播放列表 -->
                        <div @click="handleList" class="ap-button ap-playlist-button">
                ...
                <!-- 提示区 -->
                <div :class="{'ap-toast-hide': error.length<=0}" class="ap-toast">{{error}}</div>
            </div>
        </div>
    </div>
</template>
            ...
            return {
                ...
                songList: [
                    ...
                    },
                    {
                        ...
                        artist: "柏松",
                        cover: require("../../../public/imgs/home/tx.jpg"),
                        url: require("../../../public/music/sjmh.mp3")
                    },
                    {
                        id: 10,
                        name: "红旗颂",
                        ...
                        artist: "上海电影乐团",
                        cover: require("../../../public/imgs/home/tx.jpg"),
                        url: require("../../../public/music/hqs.mp3")
                    }
                ],
                homeInput: '',
                gettime: '',
